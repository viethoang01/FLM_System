<%-- 
    Document   : welcome
    Created on : Apr 13, 2023, 10:04:04 PM
    Author     : SHD
--%>
...
<html>
    ...
    <body>
                                ...
                                <ul class="main_menu">
                                    ...
                                    <li><a class="trigger" href="contact.jsp">Subject Successors</a></li>
                                        ...
                                        <li><a class="trigger" href="#">Dashboard <i class="fa fa-angle-down"></i></a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="blog_left_sidebar.jsp">Role Permission</a></li>
                                    ...
                                    <c:if test="${sessionScope.user == null}">
                                        ...
                                        <li><a class="trigger" href="#">${sessionScope.user.getUser_name()}<i class="fa fa-angle-down"></i></a>
                                            <ul class="submenu" >
                                                <li><a href="blog_right_sidebar.jsp">User Profile</a></li>
                                                <li><a href="blog_left_sidebar.jsp">Change Password</a></li>
        ...
        <div class="text-center">
            <div class="mt-5" style="font-weight: 600;font-size: 45px">Social Constructive Learning</div>
            <div class="mt-3" style="font-weight: 500;font-size: 25px">Construct knowledge  and personalize the learning way to empower leaner's full potential</div>
            <div class="mt-5"><a href="login" style="color: white"><button class="btn" style="width: 30%;">Join Now</button></a></div>
        </div>
        <footer class="text-center text-white" style="position: absolute;right: 0;bottom: 0;left: 0;padding: 1rem;background: #003152">
            <!-- Grid container -->
