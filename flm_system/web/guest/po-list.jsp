...
<html>
        ...
        <div class="container">
            <div>
                <form action="/action_page.php">
                    <div class="mb-3 mt-3">
                        <label for="email" class="form-label">Curriculum code:</label>
            ...
            <div class="container-fluid ">
                ...
                <div id="datanew">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${poList}" var="pol">
                                <tr>
                                    <td>${pol.po_id}</td>
                                    <td>${pol.name}</td>
                            ...
                            <form action=""  method="" id="siForm" enctype="multipart/form-data">
                                <table >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><a href="template-file/template-import-program-objects.xlsx" download style="text-decoration: none;color: #00a8ff">Download template</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </form>
    ...
    <script type="text/javascript">
                                                function uploadFile() {
                                                    ...
                                                    xhr.open('POST', 'POImport?cur', true);
                                                    xhr.onload = function () {
                                                        if (xhr.status === 200) {
