...
<html>
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div id="navbar" class="navbar navbar-default">
                        <div class="navbar-header col-md-1 col-sm-1 col-xs-1">
                            <a class="trigger" href="">Plo Detail</a><br>
                        </div>
        ...
        <div class="pt-3" style="margin-left:  50px;">
            ...
            &ensp;->&ensp;
            <a href="plo-list?curriculum_id=${curriculum_id}" style="color: blue">List PLO</a>
            &ensp;->&ensp;
            <a href="" style="color: blue">PLO Detail</a>
        </div>
