...
<html>
    ...
    <body>
        ...
        <div class="pt-3" style="margin-left:  50px;">
            ...
            <a href="" style="color: blue">Mapping PO PLO</a>
        </div>                            
        <div class="mt-5 text-center">
            <h4 style="font-size: 25px;">Mapping POs to PLOs</h4>
        </div>
        <form action="po-plo" method="post" id="formPost">
                                ...
                                <c:if test="${isAllow  == true}">
                                    <td>
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input" name="param ${po.po_id}_${plo.plo_id}" ${isTrue ? 'checked="true"':''}" value="true">
                                        </div>
                                    </td>
                                </c:if>
